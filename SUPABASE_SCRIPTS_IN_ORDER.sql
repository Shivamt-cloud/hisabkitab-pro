-- =============================================================================
-- HISABKITAB PRO – RUN THESE IN SUPABASE SQL EDITOR ONE BY ONE
-- Copy each "SCRIPT N" block below, paste in Supabase SQL Editor, click Run.
-- Order: 1 → 2 → 3 → 4 (each is safe to re-run).
-- =============================================================================


-- ############################################################################
-- #######################  SCRIPT 1 – RUN FIRST  ############################
-- #######################  (Base tables & triggers)  ########################
-- ############################################################################
-- Copy from next line until "END SCRIPT 1" into Supabase, then Run.
-- =============================================================================
...
-- ############################################################################
-- #######################  SCRIPT 2 – RUN SECOND  #############################
-- #######################  (Companies profile, registration, price segments) ##
-- ############################################################################
-- Copy from next line until "END SCRIPT 2" into Supabase, then Run.
-- =============================================================================
...
-- ############################################################################
-- #######################  SCRIPT 3 – RUN THIRD  #############################
-- #######################  (Services discount/parts, sales service_id, customers ID) ##
-- ############################################################################
-- Copy from next line until "END SCRIPT 3" into Supabase, then Run.
-- =============================================================================
...
-- ############################################################################
-- #######################  SCRIPT 4 – RUN FOURTH (optional)  ##################
-- #######################  (Maintenance & Alerts – only if you use that feature) ##
-- ############################################################################
-- Copy from next line until "END SCRIPT 4" into Supabase, then Run.
-- =============================================================================
