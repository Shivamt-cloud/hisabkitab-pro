      ...
      try {
        const { data, error } = await supabase!
          ...
          .insert([{
            ...
            hold_for_alteration: saleData.hold_for_alteration ?? false,
            alteration_notes: saleData.alteration_notes || null,
            alteration_type_id: saleData.alteration_type_id ?? null,
            sent_to_contact_id: saleData.sent_to_contact_id ?? null,
            amount_to_pay: saleData.amount_to_pay ?? null,
            alteration_technician_mode: saleData.alteration_technician_mode || null,
    ...
    if (isSupabaseAvailable() && isOnline()) {
      try {
        const updateData: any = {
          ...
          hold_for_alteration: updated.hold_for_alteration ?? existing.hold_for_alteration ?? false,
          alteration_notes: updated.alteration_notes ?? existing.alteration_notes ?? null,
          alteration_type_id: updated.alteration_type_id ?? existing.alteration_type_id ?? null,
          sent_to_contact_id: updated.sent_to_contact_id ?? existing.sent_to_contact_id ?? null,
          amount_to_pay: updated.amount_to_pay ?? existing.amount_to_pay ?? null,
          alteration_technician_mode: updated.alteration_technician_mode ?? existing.alteration_technician_mode ?? null,
